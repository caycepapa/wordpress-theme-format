...
<head>
    ...
    <meta property="og:description" content="<?php the_create_description();?>">
    <meta property="og:url" content="<?php the_permalink();?>">
    <meta property="og:type" content="website">
    <meta property="og:image" content="<?php the_create_ogpimage();?>">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?php the_create_title();?>">
    <meta name="twitter:description" content="<?php the_create_description();?>">
    <meta property="twitter:image" content="<?php the_create_ogpimage();?>">
